...
clear
echo -e "${B} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "                  ${B}\e[1;92;41mCREATE VMESS ACCOUNT${NC}"
echo -e " ${B}└─────────────────────────────────────────────────────┘${NC}"
echo -e ""
echo -e "     ${B}[${BIWhite}01${B}] Create Account XRAY Vmess Websocket "
echo -e "     ${B}[${BIWhite}02${B}] Trial Account XRAY Vmess     "
echo -e "     ${B}[${BIWhite}03${B}] Extending Account XRAY Vmess Active "
echo -e "     ${B}[${BIWhite}04${B}] Delete Account XRAY Vmess Websocket  "
echo -e "     ${B}[${BIWhite}05${B}] Check User Login XRAY Vmess     "
